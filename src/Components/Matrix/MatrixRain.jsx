...
const RainStream = props => {
    ...
    const [topPadding, setTopPadding] = useState(stream.length * 0);
...
const MatrixRain = props => {
    ...
    useEffect(() => {
        ...
        setContainerSize({
            width: 1000, // boundingClientRect.width,
            height: 100 // boundingClientRect.height,
        });
    }, []);

    const streamCount = containerSize ? Math.floor(containerSize.width / 40) : 0;
